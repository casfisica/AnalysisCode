void WithSysDeltaM20GeV()
{
//=========Macro generated from canvas: c/WithSysDeltaM20GeV
//=========  (Mon Feb 18 14:15:16 2019) by ROOT version 6.15/01
   TCanvas *c = new TCanvas("c", "WithSysDeltaM20GeV",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(85.71429,-0.675,204.7619,4.95);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
...
tex->SetNDC();
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("NULL","#bf{YR sys. uncer.}","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
